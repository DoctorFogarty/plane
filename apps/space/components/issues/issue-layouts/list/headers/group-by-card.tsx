...
export const HeaderGroupByCard = observer(function HeaderGroupByCard(props: IHeaderGroupByCard) {
  ...
  return (
    <>
      <button
        type="button"
        className="group/list-header relative flex w-full shrink-0 items-center gap-2 border-none bg-transparent px-2 py-1 py-1.5 text-left hover:bg-layer-transparent-hover"
