...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("db", "0127_draftissue_property_values"),
    ]
    ...
    operations = [
        ...
        migrations.AddIndex(
            ...
            index=models.Index(fields=["project", "trigger_type", "is_enabled"], name="automation_project_trigger_idx"),
        ),
        migrations.AddConstraint(
            model_name="automationrun",
            constraint=models.UniqueConstraint(
                condition=models.Q(("deleted_at__isnull", True), models.Q(("event_key", ""), _negated=True)),
                fields=("automation", "event_key", "issue"),
                name="automation_run_idempotency_when_deleted_at_null",
            ),
        ),
        migrations.AddConstraint(
            model_name="workspaceautomationbot",
            constraint=models.UniqueConstraint(
