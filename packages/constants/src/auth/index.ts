...
/** Minimum zxcvbn score accepted by the API and every setup UI. Keep in sync with `apps/api/plane/utils/password.py`. */
export const PASSWORD_MIN_ZXCVBN_SCORE = 3;

export type TPasswordScore = 0 | 1 | 2 | 3 | 4;

export type TPasswordFeedbackKey = "common" | "sequence" | "year" | "repeat" | "avoid_common" | "add_words";

export type TPasswordAssessment = {
  score: TPasswordScore;
  acceptable: boolean;
  warningKey: TPasswordFeedbackKey | null;
  suggestionKeys: TPasswordFeedbackKey[];
};
